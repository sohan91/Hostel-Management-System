...
//     @GetMapping("/hostel/registration")
...
//     @GetMapping("/hostel/password-reset")
...
//     @GetMapping("/hostel/admin-profile")
...
//     @GetMapping("/hostel/logout-session")
...
//     @GetMapping("/hostel/session-status")
